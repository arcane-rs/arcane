...
pub mod codegen {
    ...
    /// Trait contains all combinations of [`Name`]s and [`Revision`]s of this
    /// [`Event`], corresponding to their Rust types.
    ///
    /// **Note**: This trait is generated by `#[derive(Event)]`
    ///           or `#[derive(event::Versioned)]` and not part of the public
    ///           API. Do not use it directly. Instead, use [`reflect::Meta`].
    ///
    /// [`Event`]: super::Event
    /// [`Name`]: super::Name
    /// [`reflect::Meta`]: super::reflect::Meta
    /// [`Revision`]: super::Revision
    pub trait Meta {
        /// All combinations of unique Rust type identifiers with their
        /// [`Name`]s and [`Revision`]s.
        ///
        /// [`Name`]: super::Name
        /// [`Revision`]: super::Revision
